...
library(knitr)
include_graphics("/Users/martin/Github/martin/images/01.svg") 
```
...
```{r  out.width = "100%", echo=FALSE}
library(knitr)
include_graphics("/Users/martin/Github/martin/images/02.svg") 
```
...
```{r  out.width = "100%", echo=FALSE}
library(knitr)
include_graphics("/Users/martin/Github/martin/images/03.svg") 
```
...
```{r  out.width = "100%", echo=FALSE}
library(knitr)
include_graphics("/Users/martin/Github/martin/images/04.svg") 
```
