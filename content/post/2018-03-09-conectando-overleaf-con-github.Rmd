...
Molestando en twitter, me encontré con esta [página](https://medium.com/@arinbasu/a-tutorial-on-how-to-interface-an-r-notebook-with-overleaf-11f23c306cfd) que, como menciona su nombre, habla sobre cómo interactuar entre R Notebook y Overleaf. Me pareció interesante y recordé que hace algún tiempo quise conectar Overleaf y Github para mis trabajos de la universidad pero que lo había olvidado.
...
Pueda que parezca bastante técnico lo anteriormente descrito. Sí, lo es. La idea es que ya se tenga familiaridad con Git, Github, LaTeX y con todo su entorno. 
